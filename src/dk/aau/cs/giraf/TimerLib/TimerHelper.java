...
public class TimerHelper {
	...
	public void loadPredef(){
		...
		Hourglass hourglass30sec = new Hourglass("Timeglas - 30 sek", "Timeglas - (00:30)", 0xff3D3D3D, 0xffffffff, 0xffB8B8B8, 0xff000000, 30, false);
		Hourglass hourglass1min = new Hourglass("Timeglas - 1 min", "Timeglas - (01:00)", 0xff3D3D3D, 0xff000066, 0xffB8B8B8, 0xff000000, 60, false);
		Hourglass hourglass3min = new Hourglass("Timeglas - 3 min", "Timeglas - (03:00)", 0xff3D3D3D, 0xffFFFF00, 0xffB8B8B8, 0xff000000, 180, false);
		Hourglass hourglass5min = new Hourglass("Timeglas - 5 min", "Timeglas - (05:00)", 0xff3D3D3D, 0xff000066, 0xffB8B8B8, 0xff000000, 300, false);
		Hourglass hourglass10min = new Hourglass("Timeglas - 10 min", "Timeglas - (10:00)", 0xff3D3D3D, 0xffFF0000, 0xffB8B8B8, 0xff000000, 600, false);
		Hourglass hourglass30min = new Hourglass("Timeglas - 30 min", "Timeglas - (30:00)", 0xff3D3D3D, 0xff000000, 0xffB8B8B8, 0xff000000, 1800, false);
		...
		ProgressBar ProgressBar30sec = new ProgressBar("ProgressBar - 30 sek", "ProgressBar - (00:30)", 0xff3D3D3D, 0xffffffff, 0xffB8B8B8, 0xff000000, 30, false);
		ProgressBar ProgressBar1min = new ProgressBar("ProgressBar - 1 min", "ProgressBar - (01:00)", 0xff3D3D3D, 0xff000066, 0xffB8B8B8, 0xff000000, 60, false);
		ProgressBar ProgressBar3min = new ProgressBar("ProgressBar - 3 min", "ProgressBar - (03:00)", 0xff3D3D3D, 0xffFFFF00, 0xffB8B8B8, 0xff000000, 180, false);
		ProgressBar ProgressBar5min = new ProgressBar("ProgressBar - 5 min", "ProgressBar - (05:00)", 0xff3D3D3D, 0xff000066, 0xffB8B8B8, 0xff000000, 300, false);
		ProgressBar ProgressBar10min = new ProgressBar("ProgressBar - 10 min", "ProgressBar - (10:00)", 0xff3D3D3D, 0xffFF0000, 0xffB8B8B8, 0xff000000, 600, false);
		ProgressBar ProgressBar30min = new ProgressBar("ProgressBar - 30 min", "ProgressBar - (30:00)", 0xff3D3D3D, 0xff000000, 0xffB8B8B8, 0xff000000, 1800, false);
		...
		DigitalClock DigitalClock30sec = new DigitalClock("DigitalClock - 30 sek", "DigitalClock - (00:30)", 0xff3D3D3D, 0xffffffff, 0xffB8B8B8, 0xff000000, 30, false);
		DigitalClock DigitalClock1min = new DigitalClock("DigitalClock - 1 min", "DigitalClock - (01:00)", 0xff3D3D3D, 0xff000066, 0xffB8B8B8, 0xff000000, 60, false);
		DigitalClock DigitalClock3min = new DigitalClock("DigitalClock - 3 min", "DigitalClock - (03:00)", 0xff3D3D3D, 0xffFFFF00, 0xffB8B8B8, 0xff000000, 180, false);
		DigitalClock DigitalClock5min = new DigitalClock("DigitalClock - 5 min", "DigitalClock - (05:00)", 0xff3D3D3D, 0xff000066, 0xffB8B8B8, 0xff000000, 300, false);
		DigitalClock DigitalClock10min = new DigitalClock("DigitalClock - 10 min", "DigitalClock - (10:00)", 0xff3D3D3D, 0xffFF0000, 0xffB8B8B8, 0xff000000, 600, false);
		DigitalClock DigitalClock30min = new DigitalClock("DigitalClock - 30 min", "DigitalClock - (30:00)", 0xff3D3D3D, 0xff000000, 0xffB8B8B8, 0xff000000, 1800, false);
		...
		TimeTimer TimeTimer30sec = new TimeTimer("Ur - 30 sek", "Ur - (00:30)", 0xff3D3D3D, 0xffffffff, 0xffB8B8B8, 0xff000000, 30, false);
		TimeTimer TimeTimer1min = new TimeTimer("Ur - 1 min", "Ur - (01:00)", 0xff3D3D3D, 0xff000066, 0xffB8B8B8, 0xff000000, 60, false);
		TimeTimer TimeTimer3min = new TimeTimer("Ur - 3 min", "Ur - (03:00)", 0xff3D3D3D, 0xffFFFF00, 0xffB8B8B8, 0xff000000, 180, false);
		TimeTimer TimeTimer5min = new TimeTimer("Ur - 5 min", "Ur - (05:00)", 0xff3D3D3D, 0xff000066, 0xffB8B8B8, 0xff000000, 300, false);
		TimeTimer TimeTimer10min = new TimeTimer("Ur - 10 min", "Ur - (10:00)", 0xff3D3D3D, 0xffFF0000, 0xffB8B8B8, 0xff000000, 600, false);
		TimeTimer TimeTimer30min = new TimeTimer("Ur - 30 min", "Ur - (30:00)", 0xff3D3D3D, 0xff000000, 0xffB8B8B8, 0xff000000, 1800, false);
